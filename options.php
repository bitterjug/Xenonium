...
function optionsframework_options() {
	...
	$options[] = array( "name" => "Masthead Logo",
						"desc" => "255 px wide Logo, top of left sidebar",
						"id" => "masthead_logo",
                        "std" => "/wp-content/themes/Xenonium/images/Xenonium-logo-255.png",
						"type" => "text");		

	$options[] = array( "name" => "Masthead Logo alt text",
						"desc" => "Text to replace logo image",
